    ...
    R: Repository<Topic> + TopicRepository,
{
    ...
    pub async fn create_topic(
        ...
        // Create topic using correct parameter order
        let topic = Topic::new(user_id.to_string(), title, description);
    ...
    pub async fn create_derived_topic(
        ...
        // Create new topic with corrected parameters
        let new_topic = Topic::new(user_id.to_string(), title, description);
    ...
    pub async fn archive_topic(&self, topic_id: &str) -> Result<bool, BitacoraError> {
        ...
        // TODO: Implement archive method in Topic model
        // topic.archive();
        println!("Archiving topic: {}", topic_id);
    ...
    pub async fn activate_topic(&self, topic_id: &str) -> Result<bool, BitacoraError> {
        ...
        // TODO: Implement activate method in Topic model
        // topic.activate();
        println!("Activating topic: {}", topic_id);
        self.update_topic(topic).await
    }
    ...
    pub async fn add_tag_to_topic(&self, topic_id: &str, tag: String) -> Result<bool, BitacoraError> {
        ...
        // TODO: Implement add_tag method in Topic model
        // topic.add_tag(tag);
        println!("Adding tag '{}' to topic: {}", tag, topic_id);
        self.update_topic(topic).await
    }
    ...
    pub async fn remove_tag_from_topic(&self, topic_id: &str, tag: &str) -> Result<bool, BitacoraError> {
        ...
        // TODO: Implement remove_tag method in Topic model
        // topic.remove_tag(tag);
        println!("Removing tag '{}' from topic: {}", tag, topic_id);
        self.update_topic(topic).await
    }
    ...
    pub async fn set_topic_priority(&self, topic_id: &str, priority: Priority) -> Result<bool, BitacoraError> {
        ...
        // TODO: Implement set_priority method in Topic model
        // topic.set_priority(priority);
        println!("Setting priority for topic: {}", topic_id);
        self.update_topic(topic).await
    }
}
